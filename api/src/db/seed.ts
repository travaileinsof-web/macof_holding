...
async function seed() {
  ...
  const FILIALES = [
    ...
    },
    {
      ...
      image_url: "https://image.pollinations.ai/prompt/mining%20quarry%20industrial%20heavy%20machinery?width=2000&height=1200&nologo=true",
      statut: "actif",
    },
    {
    ...
    },
    {
      ...
      image_url: "https://image.pollinations.ai/prompt/large%20industrial%20fishing%20vessel%20in%20ocean%20nets?width=2000&height=1200&nologo=true",
      statut: "actif",
    }
  ];
  ...
  for (const f of FILIALES) {
    await db.insert(filiales).values(f as any).onConflictDoUpdate({
  ...
  const pagesData = [
    ...
    { page_slug: "home", section_key: "realisations", content_value: JSON.stringify([
      ...
      { title: "Exploitation Minière", category: "Mining", image: "https://image.pollinations.ai/prompt/mining%20quarry%20industrial%20heavy%20machinery?width=2000&height=1200&nologo=true" },
      ...
      { title: "Ressources Marines", category: "Fishing", image: "https://image.pollinations.ai/prompt/large%20industrial%20fishing%20vessel%20in%20ocean%20nets?width=2000&height=1200&nologo=true" },
    ]), content_type: "json" },
    ...
    { page_slug: "mining", section_key: "hero_bg", content_value: "https://image.pollinations.ai/prompt/mining%20quarry%20industrial%20heavy%20machinery?width=2000&height=1200&nologo=true", content_type: "text" },
    ...
    { page_slug: "fishing", section_key: "hero_bg", content_value: "https://image.pollinations.ai/prompt/large%20industrial%20fishing%20vessel%20in%20ocean%20nets?width=2000&height=1200&nologo=true", content_type: "text" },
