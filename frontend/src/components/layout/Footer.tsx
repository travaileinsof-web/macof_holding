  ...
  return (
    <footer className="bg-[#050b14] border-t border-white/10 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-start">
        <div className="mb-8 md:mb-0">
          ...
          <div className="mt-6 space-y-2 text-xs font-sans text-white/70">
            ...
            <p className="flex items-start gap-2 max-w-[280px]">
              <span className="text-red-500">📍</span> Manquepa en face de Banc Bleu, Kaloum, Conakry, République de Guinée
            </p>
          </div>
        </div>
        <div className="flex gap-8 text-sm text-white/80 font-light mt-8 md:mt-0">
          <div className="flex flex-col gap-3">
            <span className="text-white font-serif mb-2 uppercase tracking-widest text-xs">Nos Filiales</span>
            <Link to="/immobilier" className="hover:text-white transition-colors">Immobilier & BTP</Link>
            <Link to="/restauration" className="hover:text-white transition-colors">Restauration</Link>
            <Link to="/print" className="hover:text-white transition-colors">Print & Com</Link>
            <Link to="/mining" className="hover:text-white transition-colors">Mining</Link>
            <Link to="/transit" className="hover:text-white transition-colors">Transit & Logistique</Link>
            <Link to="/fishing" className="hover:text-white transition-colors">Fishing</Link>
          </div>
          <div className="flex flex-col gap-3">
            ...
            <Link to="/domaines" className="hover:text-white transition-colors">Domaines d'activité</Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-8 border-t border-white/5 text-center text-white/50 text-xs font-light tracking-wider">
        &copy; {new Date().getFullYear()} MACOF Holding — L'art de façonner l'avenir. Tous droits réservés.
      </div>
    </footer>
  );
}
